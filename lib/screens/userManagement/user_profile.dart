...
//     //showEditUser = await SharedPreferenceService.getClaimForSubfeature(SharedPreferenceService.CAMVC)??false;
//     print(
//         '1st claim: ${await SharedPreferenceService.getClaimForSubfeature(
//             SharedPreferenceService.NCMEU) ?? false}');
//     print(
//         '2nd claim: ${await SharedPreferenceService.getClaimForSubfeature(
//             SharedPreferenceService.CUMEU) ?? false}');
//     print(
//         '3rd claim: ${await SharedPreferenceService.getClaimForSubfeature(
//             SharedPreferenceService.EMPEU) ?? false}');
//     showEditUser = (await SharedPreferenceService.getClaimForSubfeature(
//         SharedPreferenceService.NCMEU) ??
//         false) ||
//         ((await SharedPreferenceService.getClaimForSubfeature(
...
//       }
//       print(
//           'Tab Index: ${_tabController
//               ?.index} Selected Screen: $_selectedScreen');
//     });
//     setState(() {
//       _tabsLoading = false;
//     });
...
//       UserProfileProvider provider) async {
//     try {
//       final pickedFile =
//       await ImagePicker().pickImage(source: ImageSource.gallery);
//       if (pickedFile == null) return;
...
// }
//
// Widget _changePasswordBottomSheet(BuildContext sheetContext,
