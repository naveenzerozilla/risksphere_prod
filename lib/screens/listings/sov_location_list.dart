...
class _SovLocationListState extends State<SovLocationList> with TickerProviderStateMixin {
                                  ...
                                  child: CustomButton(
                                    onPressed: () async {
                                      ...
                                      if(success.isNotEmpty && success.contains('+')){
                                        ...
                                        Navigator.push(context, MaterialPageRoute(builder: (_) => MappingScreen(tempId: success, accountId: widget.accountID??"", accountName: widget.accountName??"",subAccountId: widget.subAccountID,)));
