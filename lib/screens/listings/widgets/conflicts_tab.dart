...
class ConflictsTabState extends State<ConflictsTab> {
  ...
  Future<void> _getData() async {
    ...
    if (Provider.of<UploadSovProvider>(context, listen: false).conflictLocations.isNotEmpty) {
      _updateMap();
    }
  }
                  ...
                  initialCameraPosition: CameraPosition(
                    target: provider.conflictLocations.isNotEmpty &&
                        provider.conflictLocations[currentIndex]['conflicts']
                            .isNotEmpty
                        ? LatLng(
                      provider.conflictLocations[currentIndex]['conflicts'][0]
                      ['latitude'],
                      provider.conflictLocations[currentIndex]['conflicts'][0]
                      ['longitude'],
                    )
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ListView.builder(
                                      ...
                                      itemCount: provider.conflictLocations[currentIndex]
                                      ['conflicts']
                                          .length >
                                          3
                                          ? 3
                    ...
                    MessageCard(
                      messageTextSpans: [
                        ...
                        TextSpan(
                          ...
                          recognizer: TapGestureRecognizer()..onTap = () {
                            widget.masterTabController?.animateTo(1);  // Navigate to Conflicts tab
                          },
                        ),
                        TextSpan(
