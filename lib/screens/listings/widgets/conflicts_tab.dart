...
class ConflictsTabState extends State<ConflictsTab> {
  ...
  //
  //   final currentItem = conflictData[currentIndex];
  //   final locationId = currentItem is MyLocation
  //       ? currentItem.id
  //       : (currentItem as Conflicts).locationId;
  //
  //   final success = await provider.resolveConflict([
  //     {'conflict_index': currentIndex, 'location_id': locationId}
  //   ]);
  //
  //   if (!mounted) return;
  //
  ...
  //         widget.location!.removeAt(currentIndex);
  //       } else {
  //         widget.conflict!.removeAt(currentIndex);
  //       }
  //
  //       if (currentIndex >= conflictData.length)
  //         currentIndex = conflictData.isNotEmpty ? conflictData.length - 1 : 0;
  //       selectedOption = 'none';
  //       selectedValue = null;
  //       selectedIndex = null;
  //       isResolving = false;
...
//           position: LatLng(currentConflict.latitude ?? 0.0,
//               currentConflict.longitude ?? 0.0),
//           icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
//           infoWindow: InfoWindow(title: 'Main Location', snippet: finalAddress),
//         ));
//       }
//
...
//             position:
//                 LatLng(conflict.latitude ?? 0.0, conflict.longitude ?? 0.0),
//             icon:
...
//                                             .geocodedAddress ??
//                                         ''
//                                     : (currentItem as Conflicts).address ??
//                                         widget.geocodingAddress ??
//                                         '',
//                                 maxLines: 3,
//                                 style: typography.H4.copyWith(
...
//                         key: ValueKey(selectedOption), // Force rebuild
//                         children: widget.conflict!
//                             .take(3) // 👈 only take first 2 items safely
//                             .toList()
//                             .asMap()
//                             .entries
//                             .map((entry) {
