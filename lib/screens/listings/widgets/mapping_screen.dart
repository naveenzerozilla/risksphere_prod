...
//         field['spreadsheet'] = field['initialSpreadsheet'];
//         field['status'] = field['initialStatus'];
//       }
//     });
//   }
//   void _resetAutoMappedFields(Map<String, dynamic> field) {
//     setState(() {
//       if (field['initialStatus'] == 'Auto Mapped') {
//         field['spreadsheet'] = field['initialSpreadsheet'];
//         field['status'] = field['initialStatus'];
//       }
//     });
...
//                                         SizedBox(width: 10),
//                                         TextButton(
//                                           onPressed: field['spreadsheet'] !=
//                                                   field['initialSpreadsheet']
//                                               ? () {
//                                                   _resetAutoMappedFields(
//                                                       field); // Pass the specific field to reset
//                                                 }
//                                               : null,
//                                           child: Row(
//                                             children: [
