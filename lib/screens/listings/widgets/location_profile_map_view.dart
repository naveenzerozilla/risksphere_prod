...
class LocationProfileMapView extends StatefulWidget {
  final String accountId;
  final String subAccountId;
  final String? sovId;

  LocationProfileMapView(
      {required this.accountId, required this.subAccountId, this.sovId = ""});

  @override
  _LocationProfileMapViewState createState() => _LocationProfileMapViewState();
}

class _LocationProfileMapViewState extends State<LocationProfileMapView>
