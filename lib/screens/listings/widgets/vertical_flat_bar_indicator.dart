...
class VerticalFlatBarIndicator extends StatelessWidget {
  final int score; // Score from 1 to 5

  VerticalFlatBarIndicator({required this.score});
    ...
    List<Widget> bars = List.generate(5, (index) {
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(2), // Rounded corners for each bar
        ),
      );
    });
