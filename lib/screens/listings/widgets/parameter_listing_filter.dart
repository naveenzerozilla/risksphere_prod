...
class DataParameterFilterScreen extends StatefulWidget {
  ...
  const DataParameterFilterScreen({
    super.key,
  ...
  @override
  _DataParameterFilterScreenState createState() =>
      _DataParameterFilterScreenState();
}

class _DataParameterFilterScreenState extends State<DataParameterFilterScreen> {
  bool isLoading = true;
  ...
  final List<Map<String, String>> sortOptions = [
    {"key": "all_parameters", "label": "All Parameters"},
    {"key": "my_parameters", "label": "My Parameters"},
    {"key": "critical_impact", "label": "Critical Impact Parameters"},
    {"key": "medium_impact", "label": "Medium Impact Parameters"},
    {"key": "low_impact", "label": "Low Impact Parameters"},
  ];

  List<String> perilsList = ["None", "Fire", "Flood", "Earthquake"];
  String? selectedPeril = "None";
