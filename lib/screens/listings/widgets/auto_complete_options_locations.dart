...
class AutocompleteOptionsLocation extends StatefulWidget {
  ...
  @override
  State<AutocompleteOptionsLocation> createState() => _AutocompleteOptionsLocationState();
}

class _AutocompleteOptionsLocationState extends State<AutocompleteOptionsLocation> {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: Container(
        ...
        height: min(52.0 * widget.options.length, MediaQuery.of(context).size.height / 2),
        width: MediaQuery.of(context).size.width - 32,
        child: Scrollbar(
          controller: _scrollController, // Attach the ScrollController
          thumbVisibility: true, // Always show the scroll bar
          thickness: 3.0, // Adjust the thickness of the scroll bar

          radius: Radius.circular(8), // Rounded edges for the scroll bar
