...
// State fields
  ...
  void _reloadPage() {
    ...
    // Refresh data in place; do not replace route.
  ...
  Future<void> _closeOverlay() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool(
        'isFirstTimeMylocation', false); // 👈 save only when user closes it
