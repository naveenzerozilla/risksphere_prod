                              ...
                              builder: (context, provider, _) {
                                return IconButton(
                                  ...
                                  onPressed: provider.isMonitorLoading
                                      ? null
                                      : () async {
                                          final myLocationProvider = Provider
                                              .of<MyLocationListProvider>(
                                                  context,
                                                  listen: false);
                                          final success =
                                              await myLocationProvider
                                                  .addToSovMonitoring(
                                            context: context,
                                            locationIds: provider
                                                    .isGlobalSelectAll
                                                ? await myLocationProvider
                                          ...
                                          if (success && mounted) {
                                            Fluttertoast.showToast(
                                              msg:
                                                  "Location added to monitoring SOV successfully,",
        ...
        return Column(
          children: [
            ...
            if (locationListProvider.myLocationList.length > 1) ...[
              ...
              ] else if (locationListProvider.isConflict == true) ...[
                                          ...
                                          children: [
                                            Expanded(
                                                child: CustomButton(
                                                    ...
                                                    //   }
                                                    //
                                                    //   // ✅ FILE VALIDATION (UPDATED - INLINE ERROR)
                                                    //   if (files == null ||
                                                    //       files!.path.isEmpty) {
                                                    //     setState(() {
                                                    //       _fileError =
                                                    ...
                                                    //                           : CustomButton(
                                                    //                         onPressed: () async {
                                                    //                           var provider = Provider.of<UploadSovProvider>(dialogContext, listen: false);
                                                    //                           await provider.createEmptySov(dialogContext, success);
                                                    //                           Navigator.pop(dialogContext);
                                                    //                         },
                                                    //                         child: Text(
                                                    //                           LanguageService.getTranslated(dialogContext, "create"),
...
Future<void> showAddToSovMonitoringDialog({
  ...
  await showDialog(
    ...
    builder: (_) => _AddToSovMonitoringDialog(
...
class _AddToSovMonitoringDialogState extends State<_AddToSovMonitoringDialog> {
  ...
  void _validate() {
    setState(() {
      _errorText =
          _sovIdController.text.trim().isEmpty ? 'Please enter a SOV ID' : null;
    });
  }
