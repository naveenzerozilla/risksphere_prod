...
class _LocationProfileState extends State<LocationProfile>
                  ...
                  child: ListView(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            CustomButton(type: ButtonType.outlined, onPressed: () {
                              showDialog(
                                context: context,
                            ...
                            }, child: Text('Download', style: typography.Body1.copyWith(color: AppColors.primaryMain),))
                              ...
                              child: CustomButton(
                                ...
                                onPressed: () {
                                  ...
                                  Navigator.push(
                                    ...
                                    ), // Replace with your Edit Location screen
                                  );
                                },
  ...
  void _navigateLeft() {
    if ((int.tryParse(widget.page)??0) <= 0) {
      return;
    }
    Navigator.pushReplacement(
      context,
