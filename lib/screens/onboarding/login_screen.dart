        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                LanguageService.getTranslated("login_or_divider"),
          ...
          TextFormField(
            decoration: InputDecoration(
              labelText: LanguageService.getTranslated("login_emailfield_label"),
              hintText: LanguageService.getTranslated("login_emailfiled_placeholder"),
              border: const OutlineInputBorder(),
            ),
            validator: (value) {
              if (value == null || value.isEmpty) {
                return LanguageService.getTranslated("login_email_error");
              } else if (!validateEmail(value)) {
                return LanguageService.getTranslated("login_email_invalid_error");
              }
              return null;
            },
          ...
          TextFormField(
            decoration: InputDecoration(
              ...
              labelText: LanguageService.getTranslated("login_passwordfiled_label"),
              hintText: LanguageService.getTranslated("login_passwordfield_placeholder"),
              border: const OutlineInputBorder(),
            ),
            obscureText: !_showPassword,
            validator: (value) {
              if (value == null || value.isEmpty) {
                return LanguageService.getTranslated("login_password_error");
              } else if (value.length < 8) {
                return LanguageService.getTranslated("login_password_length_error");
              }
              return null;
            },
              ...
              onTap: () async {
                if (validateEmail(emailController.text)) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(LanguageService.getTranslated("reset_email_success_description")),
                    ),
                  );
                } else {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(LanguageService.getTranslated("reset_emailfield_invalid_label")),
                    ),
                  );
                }
              },
              child: Text(
                LanguageService.getTranslated("login_forgot_password"),
                style: CustomTypography.Subtitle1.copyWith(
                  color: AppColors.primaryMain,
                ),
              ),
                ...
                Expanded(
                  child: Container(
                    ...
                    child: authNotifier.isSigningIn
                      ...
                      child: Text(
                        LanguageService.getTranslated("login_submit_button"),
          ...
          GestureDetector(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  LanguageService.getTranslated("login_dont_hv_account"),
                  style: CustomTypography.Body1.copyWith(
                    color: Theme.of(context).colorScheme.onSurface,
                  ),
                ),
                Text(
                  LanguageService.getTranslated("login_register_now"),
                  style: CustomTypography.Subtitle1.copyWith(
                    color: AppColors.primaryMain,
                  ),
                ),
