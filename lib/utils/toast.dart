...
const String pleaseCheckYourInternetConnectivityAndTryAgain  = 'Please check your internet connectivity and try again';
...
successToast(String successText,BuildContext context,{isShortDurationText = false}){
  Fluttertoast.showToast(
    msg: successText,
    toastLength: isShortDurationText ? Toast.LENGTH_SHORT : Toast.LENGTH_LONG,
    gravity: ToastGravity.BOTTOM,
