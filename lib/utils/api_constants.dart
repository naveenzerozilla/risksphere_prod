...
//
// class AppConstant {
//   // https://pg-web-version-v2-857135835532.europe-west1.run.app
//   static const String Stripe_prod =
//       'pk_live_51RWO6tRwbwNkvtwyBk3hTthEuR3oWdTGMNeZ9J3gshZOOPgu7GvygcD0ckMwvgxm12JCu7EZX9Jlh7x70BLT3We400Lfw89f3z';
//   static const String REGION = "us-central1";
//
...
//
//   static String get DELETE_DATA_IMAGE =>
//       '$baseURL/data_categories/Dataparameter/';
//
//   static String get SWITCH_INDIVIDUAL_URL =>
...
//
//   static String get GET_CORPORATE_ROLES =>
//       '$baseURL/support?corporate_type=true';
//
...
//
//   static String get GET_ROLES_FOR_EMPLOYEES =>
//       '$baseURL/companies?role=internal';
//
//   static String get GET_ROLES_FOR_CORPORATE_EMPLOYEES =>
//       '$baseURL/companies?role=external';
//
...
//
//   static String get GET_CORPORATE_VERIFICATION_REQUESTS =>
//       '$baseURL/companies?leads=company';
//
//   static String get GET_USER_VERIFICATION_REQUESTS =>
//       '$baseURL/companies?leads=users';
//
...
//
//   static String get GET_CONNECTIONS =>
//       '$baseURL/user_management/current?connections=true';
//
//   static String get GET_REQUESTS => '$baseURL/user_management?requests=true';
//
//   static String get GET_NETWORK_LIST =>
//       '$baseURL/user_management_new/all_user_list?connections=true';
//
...
//
//   // static String get GET_CORPORATE_USER_NEW =>
//   //     '$baseURL/user_management_new/company_user_list';
//   static String get GET_CORPORATE_USER_NEW =>
//       '$baseURL/user_management_new/company_user_list';
//
//   //     '$baseURL/user_management_new/all_user_list';
//   //
//   // https://us-central1-project-green-r5-1-qa.cloudfunctions.net/user_management_new/company_user_list/current?pageSize=10
//   static String get GET_CORPORATE_Company =>
//       '$baseURL/send_default_data?name=Test one';
//
...
//
//   static String get NON_CORPORATE_USER_STATUS_NEW =>
//       '$baseURL/user_management_new/individual_user_list';
//
//   static String get CREATE_CORPORATE_EMPLOYEES =>
...
//
//   static String get APP_SUPPORT_URL =>
//       '$baseURL/sendEmail_to_client?type=support';
//
//   static String get MAIN_HAZARDS_TILE_PROVIDERS =>
...
//
//   static String get GIFT_CREDITS => '$baseURL/locations/gift_credits';
//
//   static String get HANDLE_VENDOR_DATA =>
...
//
//   static String get FETCH_LOCATIONS_DUPLICATION_CHECK =>
//       '$baseURL/duplicate_check';
//
//   static String get FETCH_LOCATION_DUPLICATIONS =>
//       '$baseURL/duplicate_check/duplicate';
//
//   static String get FETCH_LOCATION_CONFLICTS =>
//       '$baseURL/duplicate_check/similar';
//
//   static String get RESOLVE_LOCATION_CONFLICTS =>
//       '$baseURL/duplicate_check/resolveconflict';
//
//   static String get SKIP_LOCATION_CONFLICTS =>
//       '$baseURL/duplicate_check/skipconflict';
//
...
//
//   static String get CANCEL_SOV_UPLOAD_PROCESS =>
//       '$baseURL/user_management_new/my_last_process/cancel';
//
//   static String get TRANSFER_SOV => '$baseURL/locations/transfer_sov';
//
//   static String get TRANSFER_SUBACCOUNT =>
//       '$baseURL/locations/transfer_sub_account';
//
//   static String get TRANSFER_ACCOUNT => '$baseURL/locations/transfer_account';
//
//   static String get FETCH_SOV_UPLOAD_DATA =>
//       '$baseURL/user_management_new/my_last_process';
//
//   // Sub Accounts
...
//
//   static String get GET_VENDOR_HAZARD =>
//       '$baseURL/vendor_hazards/vendor_usage_dashboard';
//
//   static String get GET_CORPORATE_DASHBOARD =>
//       '$baseURL/vendor_hazards/corporate_usage_dashboard';
//
...
//
//   static String get IMAGE_LIST => '$baseURL/locations/getmedia';
//
...
//
//   static String get SOV_COMPLETE_STATUS1 =>
//       '$baseURL/locations/getsubdestination?';
//
//   static String get GET_LOCATION_PROFILE_INDIVIDUAL_NEW =>
//       '$baseURL/locations/getlocation';
//
//   static String get ADD_SUBDESTINATION =>
//       '$baseURL/locations/addsubdestination';
//
...
//   // Upload Images New
//   static String get UPLOAD_IMAGES_NEW =>
//       '$baseURL/locations/location_profile_images';
//
//   static String get UPLOAD_DOCUMENT_NEW => '$baseURL/locations/location_media/';
//
//   static String get DELETE_DOCUMENT_NEW => '$baseURL/locations/location_media/';
//
...
//
//   static String get GET_JOB_MONITORING_SUMMARY =>
//       '$baseURL/vendor_management/process_summary';
//
...
//
//   static String get GET_CURRENT_COMPANY_ID =>
//       '$baseURL/locations/current_company_id';
//
//   static String get CONFIGURATIONS =>
//       '$baseURL/locations/account_sub_global_configuration/global';
//
//   static String get CONFIGURATIONS_ACCOUNTS =>
//       '$baseURL/locations/account_sub_global_configuration/account';
//
//   static String get CONFIGURATIONS_SUB_ACCOUNTS =>
//       '$baseURL/locations/account_sub_global_configuration/sub_account';
//
//   static String UPDATE_CONFIGURATION =
...
//
//   static String get SUBSCRIBE_NOTIFICATION =>
//       '$baseURL/user_management_new/subscribe_notification';
//
//   static String get GET_NEWS_FEED =>
//       '$baseURL/user_management_new/getActivityFeed';
//
//   static String get GET_EVENT_INFO => '$baseURL/user_management_new/eventinfo';
//
//   static String get GET_EVENT_FEED =>
//       '$baseURL/user_management_new/getEventFeed';
//
...
//
//   static String get NOTIFICATION_READ =>
//       '$baseURL/user_management_new/update_activity_feed_read_by';
//
// // DELETE API CALL
