...
class DashboardProvider with ChangeNotifier {
  ...
  Future<DashboardModel?> getDashboardDataForRoles(
    ...
    try {
      ...
      Map<String, dynamic> response = await apiService
          .get("?type=role&month=${pickedDate.month}&year=${pickedDate.year}");
  ...
  Future<DashboardModel?> getDashboardDataForCompanies(
      BuildContext context, DateTime pickedDate) async {
    try {
      // Set loading state to true
      ...
      // Send a GET request to the API
      Map<String, dynamic> response = await apiService.get(
          "?type=company&month=${pickedDate.month}&year=${pickedDate.year}");
