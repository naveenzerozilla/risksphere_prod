...
//   }
  ...
  //     notifyListeners();
  //
  //     /// 🔥 VERY IMPORTANT: reset Google session
  ...
  // Future<void> signInWithGoogle({required BuildContext context}) async {
  //   if (_isSigningIn) return; // ⛔ prevent double tap
  //
  //   try {
  //     _isSigningIn = true;
  //     notifyListeners();
  //
  //     /// 🔥 Reset Google session (optional but safe)
  //     await _googleSignIn.signOut();
  //     await _googleSignIn.disconnect();
  //
  //     final GoogleSignInAccount? googleSignInAccount =
  ...
  //
  //     /// 🔑 Get claims
  //     final IdTokenResult token = await _user!.getIdTokenResult();
